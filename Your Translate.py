...
Label(root,text ="Made By Devraj Kashyap", font = 'arial 16', fg='black', bg='grey' , height = '5', width = '20').pack(side = 'bottom')
...
src_lang = ttk.Combobox(root, values= ('english','hindi','dutch','bengali'), width =22)
src_lang.place(x=20,y=60)
src_lang.set('Select input language')

dest_lang = ttk.Combobox(root, values= ('english','hindi','dutch','bengali'), width =22)
